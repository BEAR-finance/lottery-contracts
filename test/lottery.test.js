...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.pbear = await MockBEP20.deployed();
        ...
        await this.pbear.transfer(bob, '2000', { from: minter });
        await this.pbear.transfer(alice, '2000', { from: minter });
        await this.pbear.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.pbear.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.pbear.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.pbear.balanceOf(this.lotteryProxyAddress)).toString(), '418');
        ...
        // console.log('pbear2:', (await this.pbear.balanceOf(alice, {from: alice})).toString());
